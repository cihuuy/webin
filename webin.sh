...
cat << EOF
   +-----------------------------------------------------------+
   |  ${GREEN}${BLOD} Wellcome to  Webin  ( website base exploiting tools )${RESAT}   |
   +-----------------------------------------------------------+
...
cat << EOF
   +--------------------------------------------------------------------+
   |${BLOD}${GREEN}  w e b i n  ${WHITE}(${RESAT}  ${GREEN}b a s i c  i n f o r m a t i o n  s c a n n e r  ${WHITE})${RESAT}  |
   +--------------------------------------------------------------------+
...
cat << EOF
   +-----------------------------------------------------------+
   |      ${BLOD}${GREEN} w e b i n   ${WHITE}(${RESAT}   ${GREEN}G O O G L E  d o r k i n g   ${WHITE})${RESAT}      |
   +-----------------------------------------------------------+
...
cat << EOF
   +----------------------------------------------------------------+
   | ${BLOD}${GREEN} w e b i n   ${WHITE}(${RESAT}  ${GREEN}r e v e r s e  I P  d o m a i n  c h e c k  ${WHITE})${RESAT}  |
   +----------------------------------------------------------------+
...
cat << EOF
   +---------------------------------------------------------------+
   |   ${BLOD}${GREEN}w e b i n   ${WHITE}(${RESAT}  ${GREEN}s u b d o m a i n  e n u m e r a t i o n  ${WHITE})${RESAT}  |
   +---------------------------------------------------------------+
...
cat << EOF
   +-------------------------------------------------------------------+
   |  ${BLOD}${GREEN}w e b i n   ${WHITE}(${RESAT}${GREEN}  r e f l e c t e d  X S S  b r u t e f o r c e  ${WHITE})${RESAT}  |
   +-------------------------------------------------------------------+
...
cat << EOF
   +--------------------------------------------------------------------+
   |  ${BLOD}${GREEN}w e b i n   ${WHITE}(${RESAT}${GREEN}  S Q L  i n j e c t o r  - e r r o r  b a s e d  ${WHITE})${RESAT}  |
   +--------------------------------------------------------------------+
